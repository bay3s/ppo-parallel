...
from core.networks.stateless.stateless_actor_critic import StatelessActorCritic
...
class Trainer:
    ...
    def train(self) -> None:
        ...
        actor_critic_cls = (
            StatefulActorCritic if self.params.is_recurrent else StatelessActorCritic
        )
    ...
    def evaluate(
        ...
        Args:
            ...
            obs_rms (RunningMeanStd): Stablebaselines `running_mean_std`.
